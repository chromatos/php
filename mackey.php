...
/*
# For local testing, disable above block and use this one, M'kay?
    $trailing = "eating helping McNiggi's Shitti's horse cow pie moon is a blank";//$argv[1];
...
{   if (rand(0,7))
    ...
    {   switch(rand(0,2))
        {   case 0 : $theSentence ="m'kay";
            #case 1 : $theSentence = ""; # Insert some stuff
